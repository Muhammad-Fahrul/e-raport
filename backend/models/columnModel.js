...
// Method to provide options for boolean values
column.methods.getBooleanOptions = function () {
  if (this.columnType === 'boolean') {
    return {
      trueOption: this.trueValue,
      falseOption: this.falseValue,
    };
  }
  return null;
};

column.methods.getArrayOptions = function () {
